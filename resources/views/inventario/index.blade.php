...
<div class="container">
                            ...
                            <table id="tech-companies-1" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($primes as $prime)
                                        <tr>
                                            <td>
                                                <a href="{{ route('primes.show',$prime) }}"><img src="/img/covers/{{$prime->cover}}" alt="..." style="width: 100px;height: 100px;"></a>
                                            </td>
                                            <td>{{ $prime->id }}</td>
    ...
    <div class="container">
        ...
        <a class="btn btn-primary" href="{{ route('prime.exportar') }}">Descargar Excel</a>
